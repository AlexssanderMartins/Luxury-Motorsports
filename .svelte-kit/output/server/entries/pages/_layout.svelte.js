import { g as get_store_value, c as create_ssr_component, e as escape, a as add_attribute, b as compute_slots, d as subscribe, v as validate_component, f as each } from "../../chunks/index2.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let links = [
    ...
    {
      name: "GitHub",
      url: "https://github.com/AlexssanderMartins/Luxury-Motorsports",
      href: "_blank"
    }
  ];
  return `
      ...
      return `
        ...
        trail: () => {
          return `${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}
            ...
            return `<a class="btn btn-sm variant-ghost-surface"${add_attribute("href", link.url, 0)}${add_attribute("target", link.href, 0)} rel="noreferrer">${escape(link.name)}
				</a>`;
          })}
			`;
        },
        lead: () => {
          return `<strong class="text-xl uppercase">Luxury Autos</strong>`;
        }
      })}
	`;
    },
